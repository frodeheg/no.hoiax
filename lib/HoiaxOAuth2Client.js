...
class HoiaxOAuth2Client extends OAuth2Client {
  ...
  // '100': 'Average Ambient Temperature' - R/W - maybe
  // '101': 'AverageInletWaterTemp'       - R/W - maybe
  ...
  // '511': 'LegionellaFrequency'         - R/W - ignore
  // '512': 'MaxWaterFlow'                - R/W - maybe
  // '514': 'NextLPTime'                  - R   - ignore
  // '516': 'RegulationDiff'              - R/W - maybe
  // '517': 'RequestedPower'              - R/W - partially handled
